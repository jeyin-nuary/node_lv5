...
const express = require("express"); //라우트
const router = express.Router(); //라우트
...
// const jwt = require("jsonwebtoken"); //서비스
// const { Users } = require("../models");
// const authMiddleware = require("../middlewares/auth-middleware"); //서비스
// const bcrypt = require("bcrypt"); //서비스
// const saltRounds = 10 //서비스

// //회원가입 api
// router.post("/signup", async (req, res) => {
//     try {
//         const { nickname, password, confirmPassword } = req.body;
//         //중복되는 닉네임을 찾는다  // 컨트롤러(const)
